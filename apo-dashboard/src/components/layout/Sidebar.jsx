...
export default function Sidebar() {
  const { activeMonth, sidebarCollapsed, theme, currency, toggleSidebar, toggleTheme, toggleCurrency, setActiveMonth } = useDashboardStore()
